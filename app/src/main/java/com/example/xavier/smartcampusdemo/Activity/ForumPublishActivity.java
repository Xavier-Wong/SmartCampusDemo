...
public class ForumPublishActivity extends BaseActivity{
    ...
    private String p_author, p_content, p_title, p_type, p_img, img0, img1, img2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        publish_commit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                p_author = sharedPreferences.getString("userID","");
                p_content = publish_content.getText().toString();
                p_title = publish_title.getText().toString();
                p_type = String.valueOf(mAdapter.getPosition(mSpinner.getSelectedItem().toString())+1);
                p_img = "";
                if(img0 != null)
                    p_img = p_img + img0 +";";
                if(img1 != null)
    ...
    private class UploadThread implements Runnable {
        ...
        public void run() {
            if(filePath != null) {
                ...
                String result = UploadFileUtil.uploadImageFile(file, 2, availableName.split("\\.")[0]);
    ...
    private class MyThread implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                String post = "action=1&uid="+p_author+"&content="+p_content+"&title="+p_title+"&type="+p_type+"&img="+p_img;
    ...
    private void refresh() {
        Intent intent = new Intent(ForumPublishActivity.this, MainActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        intent.putExtra("isPublished",true);
        intent.putExtra("currentPage",Integer.parseInt(p_type)-1);
