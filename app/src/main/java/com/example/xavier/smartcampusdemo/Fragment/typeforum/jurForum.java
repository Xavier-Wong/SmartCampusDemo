...
import static com.example.xavier.smartcampusdemo.Fragment.techForum.JUR;
...
public class jurForum extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.typejurforum_fragment, container, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        mRecyclerView = (RecyclerView) activity.findViewById(R.id.jurForum_rv);
        final LinearLayoutManager mLayoutManager = new LinearLayoutManager(activity);
        mSwipeRefreshLayout = (SwipeRefreshLayout) activity.findViewById(R.id.swipe_refresh_jurlayout);
    ...
    private class MyAsyncTaskGetForumItem extends AsyncTask<Integer, String, List<forum>> {
        ...
        protected List<forum> doInBackground(Integer... pages) {
            return ForumItemService.getForumItems(pages[0], JUR);
        }
